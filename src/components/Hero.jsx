...
const Hero = () => {
  const social_media = [
    ...
    { name: "logo-linkedin", link: "https://www.linkedin.com/in/abdulsalammmuftua/" }
  ];
  return (
    <section
      id="home"
    ...
    >
      ...
      <div className="flex-1">
        <div className="md:text-left text-center">
          ...
          <a className="btn-primary w-36 mt-8 hover:bg-cyan-400 transition-all" href="#contact">Contact Me</a>
          <div className="mt-8 text-3xl flex items-center md:justify-start justify-center gap-5">
            {social_media?.map((icon, i) => (
              <a  key={i} href={icon.link} className="text-gray-600 mx-2 hover:text-white cursor-pointer" >
